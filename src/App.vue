  ...
  data(){
    return{
      todos:[
        ...
        {id:'002', title:'eat2', done:true},
        {id:'003', title:'eat3', done:true},
        {id:'004', title:'eat4', done:true}
      ]
    }
  },
  methods: {
...
.btn{
  ...
  cursor: pointer;
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.2), 0 1px 2px rgba(0, 0, 255, 0.05);
  border-radius: 4px;
}
